...
namespace InsureYouAIProject.Context
{
    public class InsureContext:IdentityDbContext<AppUser>
    {
        override protected void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("server=MYPC\\SQLEXPRESS;database=InsureYouAI;integrated security=true; trust server certificate=true");
        }
